...
import com.karaka.demo.CatalogueResponse.CapabilityAccess;
import com.karaka.demo.CatalogueResponse.ProductAccess;
...
class AccessController {
  ...
  AccessController(TenantProperties tenant) {
    this.tenant = tenant;
  }
